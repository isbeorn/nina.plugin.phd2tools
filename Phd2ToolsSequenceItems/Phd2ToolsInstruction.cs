...
namespace NINA.Plugin.Phd2Tools.Phd2ToolsTestCategory {
    /// <summary>
    ...
    public class Phd2ToolsInstruction : SequenceItem {
        /// <summary>
        ...
        public Phd2ToolsInstruction() {
            Text = Settings.Default.DefaultNotificationMessage;
        }
        public Phd2ToolsInstruction(Phd2ToolsInstruction copyMe) : this() {
            CopyMetaData(copyMe);
        }
        ...
        public override object Clone() {
            return new Phd2ToolsInstruction(this);
        }
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(Phd2ToolsInstruction)}, Text: {Text}";
        }
    }
}