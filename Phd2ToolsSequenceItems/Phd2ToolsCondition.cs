...
namespace NINA.Plugin.Phd2Tools.Phd2ToolsTestCategory {
    ...
    public class Phd2ToolsCondition : SequenceCondition {
        /// <summary>
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(Phd2ToolsCondition)}, IsTruthy: {IsTruthy}";
        }
    }
}