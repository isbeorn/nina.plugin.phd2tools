...
namespace NINA.Plugin.Phd2Tools {
    ...
    /// The user interface for the settings will be defined by a DataTemplate with the key having the naming convention "Phd2Tools_Options" where Phd2Tools corresponds to the AssemblyTitle - In this template example it is found in the Options.xaml
    /// </summary>
    ...
    public class Phd2Tools : PluginBase, INotifyPropertyChanged {
        ...
        public Phd2Tools(IProfileService profileService, IOptionsVM options, IImageSaveMediator imageSaveMediator) {
